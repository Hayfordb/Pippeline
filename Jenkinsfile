pipeline {
    ...
    stages {
        ...
        stage('Save artifacts') {
            ...
            post {
                success {
                    sh("""curl -X POST -H 'Content-type: application/json' --data '{"chat_id": "-1002218066565", "text": "Cергей Федотов собрал приложение." }' https://api.telegram.org/bot5933756043:AAE8JLL5KIzgrNBeTP5e-1bkbJy4YRoeGjs/sendMessage""")
                }
            }
        }
    }
